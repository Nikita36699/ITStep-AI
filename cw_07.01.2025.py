...
# документ3 -- Бігати більше 10 км шкідливо для здоров'я
doc3 = Document(
    page_content="Бігати більше 10 км шкідливо для здоров'я",
    metadata={
        "type":'Знання',
        "Author":"Nikita Pent"
    }
...
user_input = "Чи шкікдливо бігати більше ніж 10 км?"

result_docs = vector_store.similarity_search(
    user_input, # текст для порівняння схожесті
    k=2,        # кіль-сть документів у відповіді
)
